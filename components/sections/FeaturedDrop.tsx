    ...
    <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <p
            className="font-mono text-xs tracking-[0.2em] max-w-[220px]"
            style={{ color: "var(--muted)" }}
          >
            Limited units. Once it's gone, it's gone. No restocks.
          </p>
          <Link
            href="/shop"
            className="flex-shrink-0 font-mono text-xs tracking-[0.25em] border px-6 py-3 hover:opacity-70 transition-opacity"
        ...
        >
          <div className="relative overflow-hidden aspect-square">
            ...
            <div className="absolute top-4 left-4 right-4 flex justify-between">
              <span
                className="font-mono text-[10px] tracking-[0.25em] px-3 py-1.5"
              ...
              {product.limited && (
                <span
                  className="font-mono text-[10px] tracking-[0.2em] px-3 py-1.5"
                  style={{ background: "rgba(255,45,45,0.9)", color: "#fff" }}
                >
                  LIMITED
                </span>
              )}
            ...
            <div className="card-quick-view absolute bottom-6 left-6 right-6">
              <div
                className="w-full py-3 text-center font-display text-lg tracking-[0.15em] uppercase"
